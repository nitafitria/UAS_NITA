    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ @route('buku') }}" class="nav-link {{  request()->route()->named('buku') ? 'active' : ''}}">
          ...
          <li class="nav-item">
            <a href="{{ @route('anggota') }}" class="nav-link {{  request()->route()->named('anggota') ? 'active' : ''}} {{  request()->route()->named('tambah_anggota') ? 'active' : ''}}">
